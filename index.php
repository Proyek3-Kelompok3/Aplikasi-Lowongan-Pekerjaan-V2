...
//koneksi
session_start();
include "login_form/db_connect.php";
...
<body><br>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
            <a href="login_form/logout.php">Logout</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <center>
      <h1>
        <bold>SELAMAT DATANG DI WEBSITE PENGUMUMAN PEREKRUTAN KARYAWAN PT ESKA INDO JAYA KARANGANYAR</bold>
      </h1>
    </center>
  </div>
